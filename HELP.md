...
* The original package name 'com.mcorvera.test-demo' is invalid and this project uses 'com.mcorvera.test_demo' instead.
...
```
$ docker run --rm test-demo:0.0.1-SNAPSHOT
```
